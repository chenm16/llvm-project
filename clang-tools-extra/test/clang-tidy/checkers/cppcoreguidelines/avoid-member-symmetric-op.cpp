...
struct Test1 {
  ...
  // CHECK-MESSAGES-PRECXX20: :[[@LINE-1]]:8: warning: symmetric operator 'operator==' declared as a member function [cppcoreguidelines-avoid-member-symmetric-op]
...
struct Test2 {
  ...
  // CHECK-MESSAGES-PRECXX20: :[[@LINE-1]]:18: warning: symmetric operator 'operator==' declared as a member function [cppcoreguidelines-avoid-member-symmetric-op]

  Test2 operator+(Test2 const &) const;
  // CHECK-MESSAGES-BINPLUS: :[[@LINE-1]]:9: warning: symmetric operator 'operator+' declared as a member function [cppcoreguidelines-avoid-member-symmetric-op]
};
...
struct Test3 {
  ...
  // CHECK-MESSAGES-BINPLUS23: :[[@LINE-1]]:9: warning: symmetric operator 'operator+' declared as a member function [cppcoreguidelines-avoid-member-symmetric-op]
